# Generated by Django 5.1.2 on 2025-03-08 15:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите жанры книги', max_length=200, verbose_name='Жанр книги')),
            ],
        ),
        migrations.CreateModel(
            name='Language',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите статус экземпляра книги', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('author', models.ManyToManyField(help_text='Введите автора книги', to='catalog.author', verbose_name='автор книги')),
                ('genre', models.ForeignKey(help_text='Выберите язык для книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.genre', verbose_name='язык книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(help_text='Введите инвентарный номер книги', max_length=200, null=True, verbose_name='инвентарный номер книги')),
                ('imprint', models.CharField(help_text='Введите издательство и год выпуска книги', max_length=200, verbose_name='Издательство')),
                ...
                ('status', models.ForeignKey(help_text='Введите состояник экземпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='статус экземпляра книги')),
            ],
        ),
    ]
